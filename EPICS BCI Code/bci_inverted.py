...
class IndividualBraillerView_inverted:
    ...
    def build_header(self):
        self.title_header_canvas = tk.Canvas(
            self.root, 
            width=1035, 
            height=110, 
            background="#000000", 
        ...
        self.title_header_canvas.place(x=5, y=5, anchor="nw")

        title = create_inverted_label(
            self.root, 'nw', 
        ...
        self.perk_braille_img = load_img(
            "EPICS BCI Code\\Images\\Inverted Images\\PERK_Braille_Image_inverted.png", 
            size=(302,110)
        )
    ...
    def build_navigation_buttons(self):
        self.triangle_image_1 = load_img(
            "EPICS BCI Code\\Images\\Inverted Images\\triangles_icon_inverted.png", 
            size=(60,115)
        )

        self.triangle_image_2 = load_img(
            "EPICS BCI Code\\Images\\Inverted Images\\triangles_icon_flipped_inverted.png", 
            size=(60,115)
        )
        ...
        label_live_text_feed = create_inverted_label(
            self.root, 'w', 
            txt="Live Text Feed",  
            font_txt="Roboto Condensed", 
            font_size=20, 
        ...
        label_contraction_library = create_inverted_label(
            self.root, 'w', 
        ...
        self.Brailler_connected_image = load_img(
            "EPICS BCI Code\\Images\\Inverted Images\\Brailler_Connected_Icon_inverted.png", 
            size=(100,100)
        )
        ...
        label_sub_title_1 = create_inverted_label(
            self.root, 'w', 
        ...
        self.online_dot = load_img(
            "EPICS BCI Code\\Images\\Inverted Images\\green_circle_inverted.png", 
            size=(40,40)
        )
        ...
        self.home_image = load_img(
            "EPICS BCI Code\\Images\\Inverted Images\\Home_icon_inverted.png", 
            size=(105,110)
        )
        ...
        label_sub_title_2 = create_inverted_label(
            self.root, 'w', 
        ...
        self.settings_image = load_img(
            "EPICS BCI Code\\Images\\Inverted Images\\settings_icon_inverted.png", 
            size=(113,100)
        )
        ...
        label_sub_title_3 = create_inverted_label(
            self.root, 'w', 
            txt="Settings",  
            font_txt="Roboto Condensed", 
            font_size=25, 
    ...
    def build_live_feed(self):
        ...
        self.new_file_img = load_img(
            "EPICS BCI Code\\Images\\Inverted Images\\New_file_button_inverted.png", 
            size=(120, 35)
        )
        ...
        self.export_text_file_img = load_img(
            "EPICS BCI Code\\Images\\Inverted Images\\export_text_file_button_inverted.png", 
            size=(161, 37)
        )
        ...
        self.braille_selection_box_img = load_img(
            "EPICS BCI Code\\Images\\Inverted Images\\braille_selection_box_unselected_inverted.png", 
            size=(113, 39)
        )

        self.braille_selection_box_img_2 = load_img(
            "EPICS BCI Code\\Images\\Inverted Images\\braille_selection_box_selected_inverted.png", 
            size=(105, 42)
        )
