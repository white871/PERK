...
def load_ind_brailler(root, app, brailler_name):
    ...
    label_sub_title_1 = create_label(root, 'w', txt=brailler_name,  font_txt="Roboto Condensed", font_size=25, bold='bold', italic='roman', backround='white', location=(165, 185))
