...
perk_braille_img = load_img("Images/PERK_braille_Image_grey.png", size=(302,110))
...
######################################################
triangle_image_1 = load_img("Images/triangles_icon.png", size=(60,115))
triangle_image_2 = load_img("Images/triangles_icon_flipped.png", size=(60,115))
...
###################################################
Brailler_connected_image = load_img("Images/Brailler_Connected_Icon.png", size=(100,100))
...
online_dot = load_img("Images/green_circle.png", size=(40,40))
...
home_image = load_img("Images/Home_icon.png", size=(105,110))
...
settings_image = load_img("Images/settings_icon.png", size=(113,100))
...
text_file_path = "Data/brailler_output.txt"
braille_file_path = "Data/braille_binary.txt"
...
new_file_img = load_img("Images/New_file_button.png", size=(120, 35))
new_file_icon = make_interactive_image(button_canvas, new_file_img, 20, 18, on_click=new_file_action)

export_text_file_img = load_img("Images/export_text_file_button.png", size=(161, 37))
export_text_file_icon = make_interactive_image(button_canvas, export_text_file_img, 155, 15, on_click=export_file_action)

braille_selection_box_img = load_img("Images/braille_selection_box_unselected.png", size=(113, 39))
braille_selection_box_img_2 = load_img("Images/braille_selection_box_selected.png", size=(105, 42))
...
enabled_contractions_path = "Data/enabled_contractions.txt"
...
print("Attempting connection")
    #client.connect('perk.local', username = perk, password = perk, timeout = 3)
client.connect('perk.local',22,'perk','perk', timeout = 3)
client.invoke_shell()
print("Invoking shell")
ssh_stdin, ssh_stdout, ssh_stderr = client.exec_command('/bin/bash -lc "source pyperk/bin/activate; python transliteration.py"')
print(ssh_stdout.read().decode())
print(ssh_stderr.read().decode())

scp_client = scp.SCPClient(client.get_transport(), socket_timeout = 3.0)
print("Connected!")
#root.mainloop()