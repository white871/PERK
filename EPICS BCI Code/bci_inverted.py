...
def load_ind_brailler_inverted(root, app, brailler_name):
    ...
    def toggle_braille_selection():
        nonlocal current_mode, file_path
    ...
    label_sub_title_1 = create_inverted_label(root, 'w', txt=brailler_name,  font_txt="Roboto Condensed", font_size=25, bold='normal', italic='roman', backround='#000000', location=(165, 185))
    ...
    home_circle = create_interactive_icon(home_icon, label_sub_title_2, (52, 54), 41, True, on_select=lambda: home_select())
    ...
    settings_circle = create_interactive_icon(settings_icon, label_sub_title_3, (54, 49), 41, True, on_select=lambda: settings_select())
    ...
    def update_live_feed(force_full_refresh=False):
        ...
        nonlocal last_len, current_mode, after_id3
